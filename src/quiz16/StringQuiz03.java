...
public class StringQuiz03 {
	...
	*/
	...
	public static void main(String[] args) {
		...
		System.out.println(palindromeCheck("다시 합창 합시 다"));
	...
	public static String palindromeCheck(String words) {
		...
		for(int i = 0; i < middle; i++) { // int i = 0; i < str.length()/2; i++
			
			// 맨 앞글자 == 맨 뒷글자
			
			if(words.charAt(i) != words.charAt(words.length()-1-i)) judge = false;
		}
		
		return judge ? "회문입니다" : "회문이 아닙니다";
